...
!(function (t, n) {
  ...
  function B(t, n, e) {
    ...
    if (((r = n < t) && ((i = t), (t = n), (n = i)), 0 === (a = Y(t, n, e)) || !isFinite(a)))
      return [];
    if (a > 0) {
    ...
    return (
      ...
      (r.thresholds = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? q(F.call(t)) : q(t)), r)
          : e;
      }),
      r
    );
  ...
  xt.prototype = mt.prototype = {
    ...
    on: function (t, n) {
      ...
      for (; ++o < a; ) if ((e = (t = i[o]).type) && (e = Mt(r[e], t.name))) return e;
    },
    copy: function () {
      var t = {},
        n = this._;
  ...
  function Xt(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < h; ++u)
      (f = a.call(t, o[u], u, o) + ''),
        (c = s.get(f)) ? ((r[u] = c), (c.__data__ = o[u]), s.delete(f)) : (e[u] = new jt(t, o[u]));
  ...
  Un.prototype = In.prototype = {
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? rn : 'function' == typeof n ? an : on)(t, n, null == e ? '' : e))
        : un(this.node(), t);
    },
      ...
      (n = he.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ...
            : 8 === e
            ? Ae((n >> 24) & 255, (n >> 16) & 255, (n >> 8) & 255, (255 & n) / 255)
            : 4 === e
            ? Ae(
                ((n >> 12) & 15) | ((n >> 8) & 240),
                ((n >> 8) & 15) | ((n >> 4) & 240),
  ...
  function Te(t) {
    return (
      t instanceof ae || (t = we(t)), t ? new Ee((t = t.rgb()).r, t.g, t.b, t.opacity) : new Ee()
    );
  }
  function Se(t, n, e, r) {
  ...
  ie(ae, we, {
    ...
    ie(
      ...
      oe(ae, {
        brighter(t) {
          return (
            (t = null == t ? ce : Math.pow(ce, t)), new qe(this.h, this.s, this.l * t, this.opacity)
          );
        },
        darker(t) {
          return (
            (t = null == t ? ue : Math.pow(ue, t)), new qe(this.h, this.s, this.l * t, this.opacity)
          );
        },
        rgb() {
        ...
        formatHsl() {
          const t = Ce(this.opacity);
          return `${1 === t ? 'hsl(' : 'hsla('}${Oe(this.h)}, ${100 * Ue(this.s)}%, ${
            100 * Ue(this.l)
          }%${1 === t ? ')' : `, ${t})`}`;
        },
      }),
  ...
  ie(
    ...
    oe(ae, {
      brighter(t) {
        return (
          (t = null == t ? ce : Math.pow(ce, t)), new pr(this.h, this.s, this.l * t, this.opacity)
        );
      },
      darker(t) {
        return (
          (t = null == t ? ue : Math.pow(ue, t)), new pr(this.h, this.s, this.l * t, this.opacity)
        );
      },
      rgb() {
        ...
        (function () {
          ...
          for (; e; )
            e._call
              ...
              : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (ri = n)));
          (ii = t), mi(r);
        })(),
        (fi = 0);
    }
  ...
  function mi(t) {
    oi ||
      ...
      t - fi > 24
        ? (t < 1 / 0 && (ai = setTimeout(_i, t - li.now() - si)), ui && (ui = clearInterval(ui)))
        : (ui || ((ci = li.now()), (ui = setInterval(bi, 1e3))), (oi = 1), hi(_i)));
  }
  function xi(t, n, e) {
    var r = new gi();
    return (
  ...
  gi.prototype = yi.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? di() : +e) + (null == n ? 0 : +n)),
        this._next || ii === this || (ii ? (ii._next = this) : (ri = this), (ii = this)),
        (this._call = t),
        (this._time = e),
        mi();
    },
  ...
  function zi(t, n) {
    var e;
    return (
      'number' == typeof n ? Pr : n instanceof we ? Mr : (e = we(n)) ? ((n = e), Mr) : Fr
    )(t, n);
  }
  function Di(t) {
    return function () {
  ...
  eo.prototype = ro.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
        for (var c, f = r[u], s = f.length, l = 0; l < s; ++l)
          if ((c = f[l])) {
            for (
              var h, d = t.call(c, c.__data__, l, f), p = Ei(c, e), g = 0, y = d.length;
              g < y;
              ++g
            )
    ...
    transition: function () {
      for (
        var t = this._name, n = this._id, e = io(), r = this._groups, i = r.length, o = 0;
        o < i;
        ++o
      )
            ...
            (function (t, n, e) {
              ...
              return function () {
                var a = un(this, t),
                  ...
                  c = u + '';
                return (
                  null == u && (this.style.removeProperty(t), (c = u = un(this, t))),
  ...
  var Po = [null];
  var zo = (t) => () => t;
  function Do(t, { sourceEvent: n, target: e, selection: r, mode: i, dispatch: o }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
  ...
  var Ho = {
    ...
    Qo = { overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1 };
  function Jo(t) {
    return { type: t };
  }
  function ta(t) {
    ...
    function h(e) {
      ...
      function I(t) {
        ...
        switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
          ...
          case Uo:
            D[1]
              ? (x && ((a = Yo(S, Lo(k, D[0][0]))), (h = Yo(S, Lo(k, D[1][0]))), (x = 1)),
                w && ((c = Yo(E, Lo(N, D[0][1]))), (p = Yo(E, Lo(N, D[1][1]))), (w = 1)))
              : (x < 0
                  ? ((C = Yo(S - i, Lo(k - i, C))), (a = i + C), (h = l))
                  : x > 0 && ((C = Yo(S - l, Lo(k - l, C))), (a = i), (h = l + C)),
                w < 0
                  ? ((P = Yo(E - u, Lo(N - u, P))), (c = u + P), (p = d))
                  : w > 0 && ((P = Yo(E - d, Lo(N - d, P))), (c = u), (p = d + P)));
            break;
          case Io:
            x && ((a = Yo(S, Lo(k, i - C * x))), (h = Yo(S, Lo(k, l + C * x)))),
              w && ((c = Yo(E, Lo(N, u - P * w))), (p = Yo(E, Lo(N, d + P * w))));
        }
        h < a &&
          ((x *= -1),
          (r = i),
      ...
      if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
        ...
        if (Math.abs(s * u - c * f) > ba && i) {
          var h = e - o,
            ...
            b = _ / v,
            m = _ / y;
          Math.abs(b - 1) > ba && (this._ += 'L' + (t + b * f) + ',' + (n + b * s)),
            (this._ +=
              'A' +
              i +
              ',' +
  ...
  function Ya() {
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++u < n - 1; ) {
            for (
              o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, Ba[(f << 1) | (s << 2)].forEach(p);
              ++o < t - 1;
          ...
          for (; ++o < t - 1; )
            (l = s), (s = e[u * t + o + 1] >= r), Ba[(s << 2) | (l << 3)].forEach(p);
          function p(t) {
            var n,
              e,
              r = [t[0][0] + o, t[0][1] + u],
    ...
    return (
      ...
      (i.thresholds = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? Fa(Da.call(t)) : Fa(t)), i)
          : e;
      }),
      (i.smooth = function (t) {
  ...
  class iu {
    ...
    update() {
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        ...
        let _ = e[y];
        for (; (g = e[_]), nu(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0; )
          (v = this._addTriangle(_, c, g, r[c], -1, r[_])),
            ...
            (_ = g);
        if (y === l)
          for (; (g = n[y]), nu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0; )
  ...
  function Eu(t) {
    ...
    return isNaN(t)
      ...
      : (function (t) {
          ...
          Su(t.getUTCDate(), 2) +
          (i
            ? 'T' + Su(n, 2) + ':' + Su(e, 2) + ':' + Su(r, 2) + '.' + Su(i, 3) + 'Z'
            : r
  ...
  (lc.copy = function () {
    ...
    (lc.visitAfter = function (t) {
      var n,
        ...
        r = [];
      for (
        this._root && e.push(new oc(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  function Rc(t) {
    ...
    function l(t) {
      var n = (t = Sc(t)).fill,
        ...
        v = t.trim,
        _ = t.type;
      'n' === _ ? ((g = !0), (_ = 'g')) : Nc[_] || (void 0 === y && (y = 12), (v = !0), (_ = 'g')),
        (d || ('0' === n && '=' === e)) && ((d = !0), (n = '0'), (e = '='));
  ...
  function Ts(t, n) {
    ...
    var e = Zc((n *= Xc)),
      ...
      o = ef(n),
      a = Wc(
        of((a = us * o - cs * i) * a + (a = cs * r - as * o) * a + (a = as * i - us * r) * a),
        as * r + us * i + cs * o,
      );
    (Vf += a),
      (Qf += a * (as + (as = r))),
  ...
  function Is(t, n, e, r, i, o) {
    if (e) {
      ...
      null == i
        ? ((i = n + r * $c), (o = n - c / 2))
        : ((i = Bs(a, i)), (o = Bs(a, o)), (r > 0 ? i < o : i > o) && (i += r * $c));
  ...
  function Gs(t, n) {
    ...
    for (var f = 0, s = t.length; f < s; ++f)
      if ((h = (l = t[f]).length))
        for (
          var l, h, d = l[h - 1], p = Xs(d), g = d[1] / 2 + jc, y = ef(g), v = Zc(g), b = 0;
          b < h;
          ++b, p = x, y = M, v = A, d = m
        ) {
          var m = l[b],
            ...
            : i !== u &&
              ...
              (r = (function (t, n, e, r) {
                var i,
                  ...
                  a = ef(t - e);
                return Gc(a) > Ic
                  ? Vc((ef(n) * (o = Zc(r)) * ef(e) - ef(r) * (i = Zc(n)) * ef(t)) / (i * o * a))
                  : (n + r) / 2;
              })(e, r, o, a)),
              t.point(i, r),
              t.lineEnd(),
  ...
  var pl = {
    ...
    gl = {
      ...
      MultiPoint: function (t, n) {
        for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (vl(e[r], n)) return !0;
        return !1;
      },
      LineString: function (t, n) {
      ...
      MultiLineString: function (t, n) {
        for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (_l(e[r], n)) return !0;
        return !1;
      },
      Polygon: function (t, n) {
      ...
      MultiPolygon: function (t, n) {
        for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (bl(e[r], n)) return !0;
        return !1;
      },
      GeometryCollection: function (t, n) {
        for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) if (yl(e[r], n)) return !0;
        return !1;
      },
    };
  function yl(t, n) {
      ...
      (E.clipExtent = function (t) {
        return arguments.length
          ? ((T =
              null == t
                ? ((A = r = i = o = null), Nl)
                : ol((A = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
            C())
          : null == A
          ? null
          : [
    ...
    for (var e, r, i, o, a, u = new md(t), c = [u]; (e = c.pop()); )
      if ((i = n(e.data)) && (a = (i = Array.from(i)).length))
        for (e.children = i, o = a - 1; o >= 0; --o)
          c.push((r = i[o] = new md(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
  ...
  function kd(t, n) {
    var e, r;
    if (Pd(n, t)) return [n];
    for (e = 0; e < t.length; ++e) if (Nd(n, t[e]) && Pd(Dd(t[e], n), t)) return [t[e], n];
  ...
  function Id(t, n) {
    ...
    t: for (c = 3; c < o; ++c) {
      ...
      for (i.previous = e, i.next = r, e.next = r.previous = r = i, a = Od(e); (i = i.next) !== r; )
        (u = Od(i)) < a && ((e = i), (a = u));
      r = e.next;
    }
  ...
  function Gp(n, e, r, i) {
    ...
    switch ((i = Sc(null == i ? ',f' : i)).type) {
      case 's':
        ...
        return (
          null != i.precision || isNaN((o = Oc(a, u))) || (i.precision = o), t.formatPrefix(i, u)
        );
      case '':
      case 'e':
      case 'g':
    ...
    return (
      ...
      (e.tickFormat = (n, r) => {
        if (
          ...
          null == r && (r = 10 === a ? 's' : ','),
          'function' != typeof r &&
            (a % 1 || null != (r = Sc(r)).precision || (r.trim = !0), (r = t.format(r))),
          n === 1 / 0)
        )
          return r;
      ...
      (e.nice = () =>
        r(Wp(r(), { floor: (t) => o(Math.floor(i(t))), ceil: (t) => o(Math.ceil(i(t))) }))),
      e
    );
  }
  function rg(t) {
  ...
  var Sg = gg(
    ...
    Fg = gg(
      ...
      (t, n) => (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * mg) / wg,
      (t) => t.getDate() - 1,
    ),
    qg = Fg,
    Og = Fg.range;
    ...
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (((i = n.charAt(a++)), !(o = x[i in Hy ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0))
            return -1;
  ...
  function Rx(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (e - t._y1) / (i || (r < 0 && -0)),
      u = (o * i + a * r) / (r + i);
    return (Dx(o) + Dx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
  }
  function Fx(t, n) {
    var e = t._x1 - t._x0;
  ...
  (nw.prototype = Jx.prototype),
    ...
    (t.active = function (t, n) {
      ...
      if (i)
        for (r in ((n = null == n ? null : n + ''), i))
          if ((e = i[r]).state > 1 && e.name === n) return new eo([[t]], Po, n, +r);
      return null;
    }),
    (t.arc = function () {
      var t = am,
        ...
        if ((u || (u = c = wa()), l < s && ((f = l), (l = s), (s = f)), l > tm))
          if (p > rm - tm)
            u.moveTo(l * Wb(h), l * Qb(h)),
              u.arc(0, 0, l, h, d, !g),
              s > tm && (u.moveTo(s * Wb(d), s * Qb(d)), u.arc(0, 0, s, d, h, g));
          else {
            var y,
              v,
              _ = h,
            ...
            M > tm
              ? k > tm
                ? ((y = hm(U, I, P, z, l, k, g)),
                  ...
                  k < S
                    ? u.arc(y.cx, y.cy, k, Vb(y.y01, y.x01), Vb(v.y01, v.x01), !g)
                    : (u.arc(y.cx, y.cy, k, Vb(y.y01, y.x01), Vb(y.y11, y.x11), !g),
                      u.arc(
                        0,
                        0,
                        l,
                      ...
                      u.arc(v.cx, v.cy, k, Vb(v.y11, v.x11), Vb(v.y01, v.x01), !g)))
              ...
              s > tm && w > tm
                ? E > tm
                  ? ((y = hm(D, R, q, O, s, -E, g)),
                    ...
                    E < S
                      ? u.arc(y.cx, y.cy, E, Vb(y.y01, y.x01), Vb(v.y01, v.x01), !g)
                      : (u.arc(y.cx, y.cy, E, Vb(y.y01, y.x01), Vb(y.y11, y.x11), !g),
                        u.arc(
                          0,
                          0,
                          s,
                        ...
                        u.arc(v.cx, v.cy, E, Vb(v.y11, v.x11), Vb(v.y01, v.x01), !g)))
                  : u.arc(0, 0, s, x, m, g)
                : u.lineTo(D, R);
          }
        else u.moveTo(0, 0);
    ...
    (t.contourDensity = function () {
      ...
      function l(r) {
        ...
        r.forEach(function (r, o, a) {
          ...
          La({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          ja({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
          La({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          ja({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a),
          La({ width: c, height: f, data: i }, { width: c, height: f, data: l }, o >> a),
          ja({ width: c, height: f, data: l }, { width: c, height: f, data: i }, o >> a);
      ...
      return (
        ...
        (l.thresholds = function (t) {
          return arguments.length
            ? ((s = 'function' == typeof t ? t : Array.isArray(t) ? Fa(Da.call(t)) : Fa(t)), l)
            : s;
        }),
    ...
    (t.geoBounds = function (t) {
      ...
      if (((Tf = Af = -(wf = Mf = 1 / 0)), (Pf = []), yf(t, fs), (e = Pf.length))) {
        ...
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]), (u = vs(r[1], i[0])) > a && ((a = u), (wf = i[0]), (Af = r[1]));
      }
      return (
        (Pf = zf = null),
        wf === 1 / 0 || Mf === 1 / 0
        ...
        (b.clipExtent = function (t) {
          return arguments.length
            ? ((v =
                null == t
                  ? ((d = e = r = i = null), Nl)
                  : ol((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
              _())
            : null == d
            ? null
            : [
    ...
    (t.geoPath = function (t, n) {
      ...
      function o(t) {
        return (
          t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), yf(t, e(r))),
          r.result()
        );
      }
      return (
    ...
    (t.interpolateRainbow = function (t) {
      ...
      return (Ob.h = 360 * t - 100), (Ob.s = 1.5 - 1.5 * n), (Ob.l = 0.8 - 0.9 * n), Ob + '';
    }),
    ...
    (t.pointers = function (t, n) {
      return (
        t.target && ((t = $n(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
    ...
    (t.stack = function () {
      ...
      return (
        ...
        (i.order = function (t) {
          return arguments.length
            ? ((n = null == t ? $x : 'function' == typeof t ? t : Xb(Array.from(t))), i)
            : n;
        }),
        (i.offset = function (t) {
    ...
    (t.stratify = function () {
      ...
      function r(r) {
        ...
        for (a = 0, i = h.length; a < i; ++a)
          (o = h[a]),
            (f = h[a] = new md(o)),
            null != (s = d(o, a, r)) && (s += '') && ((l = f.id = s), g.set(l, g.has(l) ? Gd : f)),
    ...
    (t.symbol = function (t, n) {
      ...
      function r() {
        let r;
        if ((e || (e = r = wa()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
    ...
    (t.thresholdFreedmanDiaconis = function (t, n, e) {
      return Math.ceil((e - n) / (2 * (Z(t, 0.75) - Z(t, 0.25)) * Math.pow(l(t), -1 / 3)));
    }),
    ...
    (t.zoom = function () {
      ...
      function A(t, ...n) {
        ...
        function h(t) {
          ...
          a.event(t).zoom(
            'mouse',
            o(_(a.that.__zoom, (a.mouse[0] = Hn(t, i)), a.mouse[1]), a.extent, f),
          );
        }
        function d(t) {
      ...
      function S(e, ...i) {
        if (r.apply(this, arguments)) {
          ...
          for (ew(e), a = 0; a < s; ++a)
            (c = [(c = Hn((u = f[a]), this)), this.__zoom.invert(c), u.identifier]),
              l.touch0
      ...
      function k(t, ...r) {
        if (this.__zooming) {
          ...
          if ((a.touch1 && !a.touch0 && ((a.touch0 = a.touch1), delete a.touch1), a.touch0))
            ...
            (a.end(), 2 === a.taps && ((o = Hn(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
          ) {
