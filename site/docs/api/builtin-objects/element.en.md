...
Equals [Node.firstChild](/api/builtin-objects/node#firstchild).

<https://developer.mozilla.org/zh-CN/docs/Web/API/Element/firstElementChild>

### lastElementChild

Equals [Node.lastChild](/api/builtin-objects/node#lastchild).
...
Get the parsed style Map of [style system](/api/css/intro), e.g.
...
Returns a list of animation objects applied to the current element, see [animation system](/api/animation/waapi)

<https://developer.mozilla.org/en-US/docs/Web/API/Element/getAnimations>

### animate

Apply Keyframe animation, see [animation system](/api/animation/waapi)
