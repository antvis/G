...
可参考 [Circle](/en/api/basic/circle)。

### \<g-ellipse\>

可参考 [Ellipse](/en/api/basic/ellipse)。

### \<g-rect\>

可参考 [Rect](/en/api/basic/rect)。

需要注意 [radius](/en/api/basic/rect#radius) 需要使用数组字符串形式：
...
可参考 [Line](/en/api/basic/line)。

### \<g-path\>

可参考 [Path](/en/api/basic/path)。
