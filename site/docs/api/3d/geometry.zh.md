...
可以随时启用材质的 [wireframe](/api/3d/material#wireframe) 属性查看几何中包含的三角面：

```js
material.wireframe = true;
```

在该[示例](/examples/3d/geometry/#sphere)中效果如下，可以看出一个 Sphere 球体是由不同经纬度上的众多三角面组成：
...
立方体，[示例](/examples/3d/geometry/#cube)
...
球体，[示例](/examples/3d/geometry/#sphere)
...
平面，默认躺在 XZ 平面上，[示例](/examples/3d/geometry/#plane)
...
圆环，[示例](/examples/3d/geometry/#torus)
...
圆柱，[示例](/examples/3d/geometry/#cylinder)
...
圆锥，[示例](/examples/3d/geometry/#cone)
...
胶囊，[示例](/examples/3d/geometry/#capsule)
...
在[示例](/examples/3d/geometry/#buffer-geometry)中，我们创建了一个完全自定义的几何体，配合 [Mesh](/api/3d/mesh) 和 [MeshBasicMaterial](/api/3d/material#meshbasicmaterial)：
