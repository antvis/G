...
在[示例](/en/examples/3d/geometry/#sphere)中，我们使用 [Mesh](/en/api/3d/mesh) 创建了一个球体，它的几何形体由 [Geometry](/en/api/3d/geometry) 定义，而外观由 [MeshPhongMaterial](/en/api/3d/material#meshphongmaterial) 决定。可以看到它的很多用法和 2D 基础图形完全一样，例如添加到画布、变换等：
...
使用 Point 原语绘制。[示例](/en/examples/3d/material/#point)
...
以下参数可以在该[示例](/en/examples/3d/geometry/#sphere)中调整。
...
高光贴图。例如[示例](/en/examples/3d/geometry/#sphere)中使用的：
...
凹凸贴图，用于干扰法线。例如[示例](/en/examples/3d/geometry/#sphere)中使用的：
