...
First you need to use the [g-svg](/en/api/renderer/svg) renderer, register the plugin and it will replace the rendering of 2D graphics in [svg-renderer](/en/plugins/svg-renderer).
...
Non-`solid` fill styles leave a lot of white space, and these blank areas do not trigger interaction events. This is inconsistent with [canvas-renderer](/en/plugins/canvas-renderer).
