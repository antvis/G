...
对于非常规浏览器环境，我们也提供了例如 [WebWorker 中使用 OffscreenCanvas](/api/canvas/offscreen-canvas-ssr#在-webworker-中使用-offscreencanvas)、[服务端渲染](/api/canvas/offscreen-canvas-ssr#服务端渲染)等方案。
