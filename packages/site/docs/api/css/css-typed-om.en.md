...
We will use it to store the result of parsing a property value of type [\<length\>](/en/docs/api/css/length), for example `r: 50` will be parsed to `CSS.px(50)` and saved in `computedStyle.r`.
