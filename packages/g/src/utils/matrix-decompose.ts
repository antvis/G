...
function toRadians(arg: RadiansArg) {
  var rads = arg.rad || 0;
  var degs = arg.deg || 0;
...
function convertItemToMatrix(item: any) {
  switch (item.t) {
    case 'rotatex':
...
export function makeMatrixDecomposition(transformList: number[][]) {
