 ...
 */
@injectable()
export class ClipPath implements StylePropertyHandler<DisplayObject, DisplayObject> {
  update(oldClipPath: DisplayObject, newClipPath: DisplayObject, object: DisplayObject) {
