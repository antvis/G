...
IterationStatement
  ...
  / ForToken __
    "(" __
    (LetToken / VarToken) __ declarations:VariableDeclarationListNoIn __ ";" __
    test:(Expression __)? ";" __
    update:(Expression __)?
    ")" __
    body:Statement
  ...
  / ForToken __
    "(" __
    (LetToken / VarToken) __ declarations:VariableDeclarationListNoIn __
    InToken __
    right:Expression __
    ")" __
    body:Statement
...
ImportDeclaration
  = ImportToken __ "{" _ name:Identifier others:(_ "," _ Identifier)* _ "}" _ "from" __ moduleName:StringLiteral _ ";"
    { return { type: "ImportDeclaration", source: moduleName, specifiers: resolveList(name, others, 3).map((v) => ({type: 'ImportSpecifier', local: v})) }; }
  / ImportToken __ defaultSpecifier:Identifier __ "from" __ moduleName:StringLiteral _ ";"
    { return { type: "ImportDeclaration", source: moduleName, specifiers: [{type: 'ImportDefaultSpecifier', local: defaultSpecifier}] }; }
  / ImportToken __ "*" __ "as" __ defaultSpecifier:Identifier __ "from" __ moduleName:StringLiteral _ ";"
...
Uint      = "uint"      !IdentifierPart
Bool      = "bool"      !IdentifierPart
Vec2      = "vec2"      !IdentifierPart
Vec3      = "vec3"      !IdentifierPart
Vec4      = "vec4"      !IdentifierPart
Bvec2      = "bvec2"      !IdentifierPart
Bvec3      = "bvec3"      !IdentifierPart
Bvec4      = "bvec4"      !IdentifierPart
