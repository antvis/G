...
- Updated dependencies [f08291e]
    - @antv/g-lite@2.3.3
    - @antv/g-plugin-image-loader@2.1.27
...
- 2ae661cb: fix: wrong y coordinate when picking with webgl (#1747)

## 2.0.15

### Patch Changes

- 61ef85b2: fix: webgl renderer has logical exception when updating attributes (#1768)
