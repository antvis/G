...
export async function path(context) {
  ...
  const rect = new Rect({
    style: {
      ...
      fill: 'transparent',
      class: 'plot',
      transform: 'translate(67.39999480463388, 16)',
      width: 716.6000051953661,
      height: 516,
      clipPath: null,
    },
  });
  ...
  const path3 = new Path({
    style: {
      fillOpacity: 1,
      d: 'M365.85393334896895,513.3084327626173L359.81695798811063,518.6915672373829M359.81695798811063,518.6915672373829L362.98485449287335,518.0341898267006M359.81695798811063,518.6915672373829L360.83160070296714,515.6193996823573',
      stroke: '#3a538b',
      strokeOpacity: 1,
      opacity: 1,
      lineWidth: 1,
