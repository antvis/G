...
describe('Group', function() {
  ...
  it('clear', function() {
    ...
    expect(e1.destroyed).to.be.true;
  });
  ...
  it('contain', function() {
    ...
    expect(r1.destroyed).to.be.false;
  ...
  it('clone', function() {
    ...
    const children = clone.cfg.children;
    expect(children.length).to.equal(2);
    expect(children[0].cfg.parent).to.equal(clone);
    expect(children[1].cfg.parent).to.equal(clone);
    expect(children[1].cfg.zIndex).to.equal(4);
  });
});
